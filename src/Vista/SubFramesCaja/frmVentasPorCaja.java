 ...
 * @author Juan Manuel
 */
public class frmVentasPorCaja extends javax.swing.JFrame {

    /**
     * Creates new form frmBuscarCliente
     */
    
    public frmVentasPorCaja(){
        initComponents(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVentasPorCaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVentasPorCaja().setVisible(true);
            }
        });
    }
