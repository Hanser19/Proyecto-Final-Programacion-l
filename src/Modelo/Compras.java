 ...
 * @author Juan Manuel
 */
public class Compras extends ConexionSQL {

    String fecha;
    double total;
    static String query;

    public Compras(String fecha, double total) {
        this.fecha = fecha;
        this.total = total;
        insert();
    }
    ...
    protected void insert() {
        query = "INSERT INTO Compras (Fecha, Total) VALUES(?,?)";
    ...
    public static ArrayList<String[]> select() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                filas[0] = resultSet.getString("ComprasID");
